...
function SectionProjects({ idx }) {
  const projects = [
  { n: "01", tag: "קהילה", who: "מיכל, י׳", t: "מיפוי נגישות בשכונה", d: "התחיל משאלה על סבתא בכיסא גלגלים. נגמר בדוח עם המלצות שהוגש לרשות המקומית." },
  { n: "02", tag: "מדיה", who: "קבוצה, י״א", t: "פודקאסט על זהות", d: "סדרת שיחות עם מתבגרים על שייכות ובחירה. שלוש עונות, ולמדו תוך כדי איך מראיינים." },
  { n: "03", tag: "טכנולוגיה", who: "עומר, י״ב", t: "אפליקציה לאימון חברתי", d: "כלי דיגיטלי בשיתוף ארגון מקומי. נפל פעמיים בדרך, ועלה עם משתמשים אמיתיים." },
  { n: "04", tag: "מחקר", who: "נועה, י״א", t: "ארכיון קולות הוד השרון", d: "תיעוד היסטוריה אורלית עם ותיקי העיר. ארכיון פתוח עם עשרות ראיונות." }];
